 ...
 *
 * Palet HARDCODE (bukan token --vt-*): cabang ini juga tanpa ThemeProvider,
 * jadi `data-theme` tidak pernah diset dan selector `:root` retro90s TERANG di
 * globals.css yang berlaku — `--vt-ink` nyaris hitam di atas latar gelap.
 * Karena halaman ini memang di luar tema OS, nilainya ditulis eksplisit.
 *
