...
/**
 * Tiga test file ini (dan hanya ini) menulis/membaca berkas bersama
 ...
 *
 * Saat ketiganya dijadwalkan di worker berbeda, baca-tulis mereka berlomba:
 * beforeEach satu menghapus persis saat yang lain menulis, sehingga config
 * "hilang" dan test jatuh ke default secara acak (flaky). Karena itu ketiga
 ...
 *
 * Bila nanti ada test file ke-4 yang menyentuh local-settings.json, tambahkan
